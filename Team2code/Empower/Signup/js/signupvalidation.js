...
var fname = $("#fname");
    var namefInfo = $("#namefInfo");
   var lname = $("#lname");
    var namelInfo = $("#namelInfo");
   
   var contact = $("#contact");
    var contInfo = $("#contInfo");
   
   var cnic=$("#cnic");
   var cnicInfo=$("#cnicInfo");
   var uname = $("#username");
    ...
    function validateFName(){
        var textbxval=fname.val();
        var filter = /^[A-Za-z]{3,30}$/;
      		
        if(filter.test(textbxval))
        {
            document.getElementById('fname').style.background='white';
            namefInfo.text("Your First Name");
            document.getElementById('nameInfo').style.color='#B5B5B5';
            return true;
        }
        else
        {
            document.getElementById('fname').style.background='#FEB1B1';
            namefInfo.text("Please enter Valid Name(At least 3 characters: letters");
	...
	function validateContact(){
        var textbxval=contact.val();
        var filter = /^[0-9]{4,30}$/;
      		
        if(filter.test(textbxval))
        {
            document.getElementById('contact').style.background='white';
            contInfo.text("Your Contact");
            document.getElementById('contInfo').style.color='#B5B5B5';
            return true;
        }
        else
        {
            document.getElementById('contact').style.background='#FEB1B1';
            contInfo.text("Please enter Valid ContactS(At least 8 characters: letters");
            document.getElementById('contInfo').style.color='#B62427';
            contact.focus();
            return false;
        }
    }
	...
	function validateCNIC(){
        var textbxval=cnic.val();
        var filter = /^[0-9]{4,30}$/;
      		
        if(filter.test(textbxval))
        {
            document.getElementById('cnic').style.background='white';
            cnicInfo.text("Your CNIC");
            document.getElementById('cnicInfo').style.color='#B5B5B5';
            return true;
        }
        else
        {
            document.getElementById('cnic').style.background='#FEB1B1';
            cnicInfo.text("Please enter Valid CNIC(without -)");
            document.getElementById('cnicInfo').style.color='#B62427';
            cnic.focus();
            return false;
        }
    }
	 ...
	 function validateLName(){
        var textbxval=lname.val();
        var filter = /^[A-Za-z]{3,30}$/;
      		
        if(filter.test(textbxval))
        {
            document.getElementById('fname').style.background='white';
            namelInfo.text("Your Last Name");
            document.getElementById('nameInfo').style.color='#B5B5B5';
            return true;
        }
        else
        {
            document.getElementById('fname').style.background='#FEB1B1';
            namelInfo.text("Please enter Valid Name(At least 3 characters: letters");
            document.getElementById('nameInfo').style.color='#B62427';
            lname.focus();
            return false;
        }
	...
	function validateName(){
        ...
        else
        {
            ...
            nameInfo.text("Please enter Valid Name(At least 8 characters: letters");
            document.getElementById('nameInfo').style.color='#B62427';
            uname.focus();
            return false;
        }
	  ...
	  function validateAdress(){
        ...
        {
            document.getElementById('address').style.background='#FEB1B1';
